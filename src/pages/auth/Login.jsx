...
import { FaApple, FaMicrosoft, FaEye, FaEyeSlash, FaLock } from "react-icons/fa";
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="relative">
            <Input
              ...
              className={`w-full px-4 py-6 rounded-lg border ${errors.email ? "border-red-500" : "border-gray-300"} focus:outline-none transition-all bg-transparent text-gray-800`}
              placeholder="Email"
            />
          ...
          <div className="relative">
            <Input
              ...
              className={`w-full px-4 py-6 rounded-lg border ${errors.password ? "border-red-500" : "border-gray-300"} focus:outline-none transition-all bg-transparent text-gray-800`}
