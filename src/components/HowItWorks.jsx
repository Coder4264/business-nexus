...
export default function HowItWorks() {
  return (
    <section className="py-10 bg-white sm:py-12 md:py-18">
      ...
      <h6 class="text-base font-semibold tracking-wider text-blue-600 uppercase">how it works</h6>
            ...
            //   },
              ...
              <div key={index} >
                <div className="flex items-center justify-center w-16 h-16 mx-auto bg-blue-200/30 rounded-full ">
                  <span className="text-xl font-semibold text-blue-700">{step}</span>
                </div>
                <h3 className="mt-6 text-xl font-semibold leading-tight text-black md:mt-10">{title}</h3>
